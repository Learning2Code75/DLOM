...
import { GrAnalytics, GrClose } from "react-icons/gr";
...
const Header = () => {
  ...
  useEffect(() => {
    ...
    if (txt1 === "" || txt2 === "") {
      ...
      setActive(4);
    } else if (txt1 === "analytics" || txt2 === "analytics") {
      setActive(5);
    } else if (txt1 === "ml" || txt2 === "ml") {
      setActive(6);
    }
      ...
      <div className="sidebar">
        {!isSmallScreen ? (
          <ul className="sidebarNav">
            ...
            <li
              className={`navItem ${active === 6 ? "active" : ""}`}
              onClick={() => setActive(6)}
            >
              <Link to="/ml" className="navLink">
                {/* <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              >
                ...
                <GiArtificialHive />
                <span className="linkText">ML</span>
              </Link>
            </li>
