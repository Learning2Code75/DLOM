...
// export const updateProduct = (pId, pData) =>  API.patch(`/products/${pId}`, pData);
export const updateProduct = (pId, pData) =>
  API.patch(`http://localhost:8003/products/${pId}`, pData);

// export const deleteProduct = (pId) => API.delete(`/products/${pId}`);
export const deleteProduct = (pId) =>
  API.delete(`http://localhost:8003/products/${pId}`);
